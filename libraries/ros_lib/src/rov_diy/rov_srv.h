#ifndef _ROS_SERVICE_rov_srv_h
#define _ROS_SERVICE_rov_srv_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
...
static const char ROV_SRV[] = "rov_diy/rov_srv";

  class rov_srvRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return ROV_SRV; };
    const char * getMD5(){ return "36d09b846be0b371c5f190354dd3153e"; };

  };

  class rov_srvResponse : public ros::Msg
  {
    public:
  ...
  class rov_srv {
    public:
    typedef rov_srvRequest Request;
    typedef rov_srvResponse Response;
  };
